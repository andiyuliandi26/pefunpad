...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Master Data Kategori Ruang Karya - Update</h1>
</div>
        ...
        <div class="card-body">
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label>Nama</label>
                    <?php echo form_input('kategori', $data->kategori, ['class'=>'form-control']); ?>
                 </div>
                ...
                <div class="form-group col-md-10">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-2">
                            <img class="img-fluid" src="<?php echo base_url(); ?>/images/ruangkarya/<?php echo $data->imageurl; ?>" />
                        </div>
                    </div>
